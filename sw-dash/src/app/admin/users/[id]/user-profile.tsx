        ...
        <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-2 md:gap-3 mb-3">
              ...
              <span
                className={`px-2 py-1 rounded-lg font-mono text-xs border ${roleStyle(user.role)}`}
              >
                {user.role}
              </span>
            </div>
        ...
        <div className="bg-gradient-to-br from-zinc-900/90 to-black/90 border-4 border-amber-900/40 rounded-3xl p-4 shadow-2xl">
          ...
          {canEdit ? (
            <div className="space-y-2">
              ...
              <button
                onClick={() => grant('sw_ysws')}
                disabled={updating || user.role === 'sw_ysws'}
                className="w-full bg-teal-900/30 border-2 border-teal-700/50 text-teal-400 hover:bg-teal-900/50 font-mono text-xs px-3 py-2 rounded-xl transition-colors disabled:opacity-50"
              >
                grant SW + YSWS
              </button>
              {(currentUser.role === 'megawright' ||
        ...
        <div className="bg-gradient-to-br from-zinc-900/90 to-black/90 border-4 border-amber-900/40 rounded-3xl p-4 shadow-2xl">
          ...
          <div className="space-y-3">
            <div>
              ...
              <span
                className={`inline-block px-2 py-1 font-mono text-xs border rounded-lg ${roleStyle(user.role)}`}
              >
                {user.role}
              </span>
            </div>
